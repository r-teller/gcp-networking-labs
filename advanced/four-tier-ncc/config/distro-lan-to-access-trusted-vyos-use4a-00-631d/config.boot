...
protocols {
    bgp 4204100001 {
        ...
        neighbor 172.24.64.253 {
            ...
            disable-connected-check
            ebgp-multihop 10
            remote-as 4202000001
        }
        neighbor 172.24.64.252 {
            address-family {
                ipv4-unicast {
                    soft-reconfiguration {
                        inbound
        ...
        neighbor 172.24.0.253 {
            ...
            disable-connected-check
            ebgp-multihop 10
            remote-as 4202000002
        }
        neighbor 172.24.0.252 {
            address-family {
                ipv4-unicast {
                    soft-reconfiguration {
                        inbound
        ...
        neighbor 172.24.32.253 {
            ...
            disable-connected-check
            ebgp-multihop 10
            remote-as 4202000003
        }
        neighbor 172.24.32.252 {
            address-family {
                ipv4-unicast {
                    soft-reconfiguration {
                        inbound
